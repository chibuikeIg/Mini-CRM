    ...
    <header>
        ...
        <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">MiniCRM | {{ auth('company')->user()->name }}</a>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <ul class="navbar-nav me-auto mb-2 mb-md-0">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="/company">Home</a>
                        </li>
                    </ul>
                    <div class="d-flex">
                      <a class="btn btn-outline-success" href="{{ route('company.logout') }}" onclick="event.preventDefault();
